...
export function SocialProof() {
  return (
    <section className="relative py-10 px-6" style={{ borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)' }}>
      <div className="max-w-4xl mx-auto">
        <p className="text-center text-muted-dim text-xs uppercase tracking-widest mb-6">Trusted by Ghanaians</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0" style={{ '--tw-divide-opacity': 1 } as React.CSSProperties}>
          {[
