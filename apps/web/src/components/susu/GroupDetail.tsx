...
interface GroupDetailProps {
  ...
  /** Called when creator reorders members — receives array of member IDs in new order */
...
export function GroupDetail({
  ...
  const enterReorderMode = useCallback(() => {
    const sorted = [...group.members].sort((a, b) => a.payout_order - b.payout_order);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between px-1">
          ...
          {group.is_creator && onReorderMembers && !reorderMode && (
            <button
              type="button"
